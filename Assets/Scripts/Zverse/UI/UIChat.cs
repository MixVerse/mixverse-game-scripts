...
public partial class UIChat : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (player)
        {
            ...
            // character limit
             messageInput.characterLimit = player.zverseChat.maxLength;
            ...
            messageInput.onEndEdit.SetListener((value) => {
                ...
                {
                    string newinput = player.zverseChat.OnSubmit(value);
            ...
            sendButton.onClick.SetListener(() => {
                ...
                string newinput = player.zverseChat.OnSubmit(messageInput.text);
                messageInput.text = newinput;
                messageInput.MoveTextEnd(false);
